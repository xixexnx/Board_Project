...
public class PageHandler {
    ...
    public PageHandler(){}
    public PageHandler(String bno, int totalCnt, Integer page){
        this(totalCnt, new SearchCondition(bno, page, 10));
    }
    public PageHandler(String bno, int totalCnt, Integer page, Integer pageSize){
        this(totalCnt, new SearchCondition(bno, page, pageSize));
    }
